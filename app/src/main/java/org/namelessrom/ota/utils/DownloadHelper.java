...
public class DownloadHelper {
    ...
    public static boolean isDownloading(String fileName) {
        if (sDownloadingRom) {
            String downloadName = sPreferenceHelper.getDownloadRomName();
    ...
    public static void downloadFile(final String url, final String fileName, final String md5) {
        ...
        realDownloadFile(url, fileName, md5);
    }

    private static void realDownloadFile(String url, String fileName, String md5) {
    ...
    public static void cancelDownload(final long id) {
        new AlertDialog.Builder(sContext)
                ...
                .setMessage(R.string.cancel_rom_download_alert_summary)
